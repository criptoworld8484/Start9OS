...
const dict = {
  // main.ts
  'The Liquid RPC Interface is ready': 1,
  'The Liquid RPC Interface is not ready': 2,
  'Blockchain Sync': 3,
  'Liquid is fully synced': 4,
  'Liquid is starting…': 5,
  ...
  'Peer Interface': 102,
  'Listens for incoming connections from peers on the Liquid network': 103,
  ...
  // dependencies.ts
  'Liquid requires an archival Bitcoin node for peg-in validation.': 2005,
} as const
