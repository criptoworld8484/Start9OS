...
export default {
  es_ES: {
    // main.ts
    1: 'La interfaz RPC de Liquid está lista',
    2: 'La interfaz RPC de Liquid no está lista',
    3: 'Progreso de sincronización de blockchain',
    4: 'Liquid está completamente sincronizado',
    5: 'Liquid está iniciando…',
    ...
    103: 'Escucha conexiones entrantes de pares en la red Liquid',
    104: 'Interfaz ZeroMQ',
    ...
    1742: 'Cambiar este valor reiniciará automáticamente el servicio.',
    ...
    2005: 'Liquid requiere un nodo Bitcoin archival para validar los peg-ins.',
  } satisfies LangDict,
  de_DE: {
    // main.ts
    1: 'Die Liquid RPC-Schnittstelle ist bereit',
    2: 'Die Liquid RPC-Schnittstelle ist nicht bereit',
    3: 'Blockchain-Synchronisationsfortschritt',
    4: 'Liquid ist vollständig synchronisiert',
    5: 'Liquid startet…',
    ...
    103: 'Wartet auf eingehende Verbindungen von Peers im Liquid-Netzwerk',
    104: 'ZeroMQ-Schnittstelle',
    105: 'I2P-Daemon-Konsole',
    106: 'Schnittstelle zum Zugriff auf die eingebettete I2P-Daemon-Konsole',
    107: 'Streamt Echtzeit-Benachrichtigungen über Bitcoin-Blöcke und Transaktionen (Hashes und Rohdaten)',
    ...
    1742: 'Das Ändern dieses Werts startet den Dienst automatisch neu.',
    ...
    2005: 'Liquid benötigt einen archivierenden Bitcoin-Knoten zur Validierung von Peg-ins.',
  } satisfies LangDict,
  pl_PL: {
    // main.ts
    1: 'Interfejs RPC Liquid jest gotowy',
    2: 'Interfejs RPC Liquid nie jest gotowy',
    3: 'Postęp synchronizacji blockchain',
    4: 'Liquid jest w pełni zsynchronizowany',
    5: 'Liquid się uruchamia…',
    ...
    103: 'Nasłuchuje przychodzących połączeń od peerów w sieci Liquid',
    104: 'Interfejs ZeroMQ',
    105: 'Konsola daemona I2P',
    106: 'Interfejs dostępu do konsoli wbudowanego daemona I2P',
    107: 'Strumieniuje powiadomienia o blokach i transakcjach Bitcoin w czasie rzeczywistym (hashe i surowe dane)',
    ...
    1742: 'Zmiana tej wartości spowoduje automatyczne ponowne uruchomienie usługi.',
    ...
    2005: 'Liquid wymaga archiwalnego węzła Bitcoin do walidacji peg-inów.',
  } satisfies LangDict,
  fr_FR: {
    // main.ts
    1: "L'interface RPC Liquid est prête",
    2: "L'interface RPC Liquid n'est pas prête",
    3: 'Progression de la synchronisation blockchain',
    4: 'Liquid est entièrement synchronisé',
    5: 'Liquid démarre…',
    ...
    103: 'Écoute les connexions entrantes des pairs sur le réseau Liquid',
    ...
    1742: 'La modification de cette valeur redémarrera automatiquement le service.',
    ...
    2005: 'Liquid nécessite un nœud Bitcoin archival pour valider les peg-ins.',
  } satisfies LangDict,
}
