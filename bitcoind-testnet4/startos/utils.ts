...
/**
 * Selección de red. Sólo seleccionamos testnet4; NO repetimos aquí los binds
 * (rpcbind/bind/whitebind/zmq): el bitcoin.conf del paquete los define en su
 * sección por defecto y Bitcoin Core los aplica a la red activa, así que
 * pasarlos también por CLI provoca "Duplicate binding configuration".
 */
export function testnet4LaunchArgs(): string[] {
  return ['-testnet4']
}
